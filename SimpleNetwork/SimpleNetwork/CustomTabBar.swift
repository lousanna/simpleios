...
class CustomTabBar: UIView {
    ...
    let defcolor: UIColor = UIColor.init(red: 1, green: 0.4901, blue: 0.4823, alpha: 1)
    let overcolor: UIColor = UIColor.init(red: 0.6274, green: 0.03137, blue: 0.2392, alpha: 1)
    
    override init(frame: CGRect) {
        super.init(frame: frame)
        
        self.backgroundColor = defcolor
    }
    ...
    func createTabBarItemSelectionOverlay(_ containers: [CGRect]) {
        ...
        let overlayColors = [overcolor, overcolor, overcolor]
        ...
        for index in 0..<tabBarItems.count {
            ...
            //selectedItemOverlay.layer.cornerRadius = self.frame.height / 2
            //selectedItemOverlay.layer.borderWidth = 1
    ...
    func createTabBarItemSelectionOverlayMask(_ containers: [CGRect]) {
        ...
        leftMask.backgroundColor = defcolor
        ...
        rightMask.backgroundColor = defcolor
